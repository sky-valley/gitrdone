...
func TestAgentDiscoveryDocumentsContract(t *testing.T) {
	...
	t.Run("llms txt follows root markdown discovery convention", func(t *testing.T) {
		...
		requireBodyIncludes(t, body, "durably admitted as pending judgement")
		requireBodyIncludes(t, body, "the request does not run judgement or promotion")
	...
	t.Run("agents markdown is available at common agent paths", func(t *testing.T) {
		...
		for _, path := range paths {
			t.Run(path, func(t *testing.T) {
				...
				requireBodyIncludes(t, body, "reports state as pending_judgement")
				requireBodyIncludes(t, body, "Proposal admission does not run judgement or promotion inside the request")
